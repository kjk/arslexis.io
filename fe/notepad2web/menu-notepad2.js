...
const menuEdit = [
  ...
  ["&Redo\tCtrl+Y", IDM_EDIT_REDO],
  [SEPARATOR],
  ["Cu&t\tCtrl+X", IDM_EDIT_CUT],
  ["&Copy\tCtrl+C", IDM_EDIT_COPY],
  ["&Paste\tCtrl+V", IDM_EDIT_PASTE],
  ["&Delete\tDelete", IDM_EDIT_DELETE],
  ["Select &All\tCtrl+A", IDM_EDIT_SELECTALL],
