/** @typedef {import("@lezer/markdown").MarkdownConfig} MarkdownConfig */
/** @typedef {import("@lezer/markdown").MarkdownExtension} MarkdownExtension */
/** @typedef {import("@lezer/markdown").BlockContext} BlockContext */
/** @typedef {import("@lezer/markdown").LeafBlockParser} LeafBlockParser */
/** typedef {import("@lezer/markdown").Element} Element */
/** @typedef {import("@lezer/markdown").LeafBlock} LeafBlock */
